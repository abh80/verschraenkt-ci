...
import com.verschraenkt.ci.core.security.{JwtValidator, JwtClaims}
...
object JwtToken:
  /** Create a validated JWT token
    ...
    * @param validator The JWT validator to use
    * @return Either a validation error or the validated token
    */
